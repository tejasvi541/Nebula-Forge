...
class Provisioner:
    ...
    def plan_skill_creation(self, meta: SkillMetadata) -> ProvisionPlan:
        skill_dir = self.vault.skills_dir / meta.name
        ...
        return ProvisionPlan(
            ...
            total_files=1,
            total_dirs=1,
            description=f"Provision global skill '{meta.name}' in ~/.claude/skills/",
        )
